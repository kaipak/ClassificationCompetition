...
class SarcasmDetector(object):
            ...
            for (label, text), _ in self.train_iter:
                ...
                if global_step % eval_every == 0:
                    ...
                    if best_valid_loss > average_valid_loss:
                        ...
                        save_checkpoint(self.OUTPUT_DIR / 'model.pt', model,
                                        best_valid_loss)
                        save_metrics(self.OUTPUT_DIR / 'metrics.pt',
                                     train_loss_list, valid_loss_list,
                                     global_steps_list)

        save_metrics(self.OUTPUT_DIR / 'metrics.pt', train_loss_list,
    ...
    def load_metrics(self, ):
        ...
        :return:
        """
        state_dict = torch.load(self.OUTPUT_DIR, map_location=self.device)
